...
namespace cmpctircd.Threading {
    public class SynchronizationContext : System.Threading.SynchronizationContext {
        ...
        private void Process(Func<bool> predicate) {
            while(predicate()) { // While the predicate returns true
                ...
                pair.Callback(pair.State); // Run the message
    ...
    private struct CallbackStatePair {
        ...
        /// </summary>
        SendOrPostCallback Delegate { get; private set; }
        /// <summary>
        /// The object passed to the delegate.
        /// </summary>
        object State { get; private set; }
        /// <summary>
        /// The reset event for synchronous dispatch.
        /// </summary>
        ManualResetEventSlim Reset { get; private set; }
        ...
        CallbackStatePair(SendOrPostCallback d, object state, ManualResetEventSlim reset = null) {
            Delegate = d;
            State = state;
            Reset = reset;
        }
